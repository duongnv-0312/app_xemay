(function(h, g, c, j, d, l, k) { /*! Jssor */
      ...
      var e = {
          ...
          Le: function(a) {
            return a < 1 / 2 ? e.ld(a * 2) * .5 : e.jc(a * 2 - 1) * .5 + .5
          },
          Je: function() {
            return 1 - c.abs(1)
          },
      ...
      var b = new function() {
        ...
        function Ib() {
          if (!G) {
            G = {
              sf: "ontouchstart" in h || "createTouch" in g
            };
            var a;
        ...
        function Y(a) {
          a.constructor === Y.caller && a.td && a.td.apply(a, Y.caller.arguments)
        }
        f.td = Y;
        f.nb = function(a) {
        ...
        function M(d, a) {
          ...
          if (a) {
            ...
            if (J()) {
              if (a.cb || a.fb || a.U) c += " translate3d(" + (a.cb || 0) + "px," + (a.fb || 0) + "px," + (a.U || 0) + "px)";
              if (a.p == k) a.p = 1;
              if (a.q == k) a.q = 1;
        ...
        f.pg = function(d, a) {
          if (a) d.style.clip = "rect(" + c.round(a.j || a.z || 0) + "px " + c.round(a.B) + "px " + c.round(a.C) + "px " + c.round(a.k || a.s || 0) + "px)";
          else if (a !== k) {
        ...
        f.Uf = function(a, b) {
          var c = f.Zc(a);
          b & 1 && f.G(a, (f.m(c) - f.m(a)) / 2);
          b & 2 && f.F(a, (f.n(c) - f.n(a)) / 2)
        };
        f.Rb = function(b, a) {
        ...
        f.Pe = function(l, m, x, q, z, A, n) {
          ...
          if (a.g && b.og() && !a.g.j && !a.g.k && !a.g.z && !a.g.s && a.g.B == n.Y && a.g.C == n.Z) a.g = j;
          return a
        }
      };
      ...
      var i = function(p, fc) {
        ...
        function xc(o, g) {
          ...
          function E(a) {
            ...
            T(o, a, 0);
            F = d;
            q = new I.J(o, I, b.Zf(b.i(o, "idle")) || lc);
            q.v(0)
          }
            ...
            if (y.length && !G) {
              ...
              if (!W) {
                ...
                b.f(y, function(a) {
                  if (!b.A(a, "src")) {
                    a.src = b.i(a, "src2");
                    b.N(a, a["display-origin"])
                  }
                })
              }
              b.mf(y, k, b.K(j, M, c, a))
            } else M(c, a)
          };
          e.Wd = function() {
            var h = g;
          ...
          function T(a, c, e) {
            ...
            if (!F) {
              if (a.tagName == "IMG") {
                ...
                if (!b.A(a, "src")) {
                  Q = d;
                  a["display-origin"] = b.N(a);
                  b.Q(a)
                }
              }
              b.rd() && b.u(a, (b.u(a) || 0) + 1)
            }
            var f = b.tb(a);
            b.f(f, function(f) {
              var h = f.tagName,
              ...
              if (i == "caption") {
                ...
                if (h == "A") {
                  if (b.i(f, "u") == "image") k = b.gf(f, "IMG");
                  else k = b.D(f, "image", d);
                  if (k) {
                    x = f;
                    b.N(x, "block");
                    b.P(x, V);
        ...
        function vc(y, g, p, q) {
          ...
          a.Qf = function() {
            A && A.eb == g && A.Lb();
            var b = a.wb();
            b < c && f.l(i.Pc, g, -b - 1, n, j, e, c)
          };
          a.Fc = function(a) {
            p && b.Jb(jb, a && p.fc.zg ? "" : "hidden")
          };
          a.Wb = function(b, a) {
            if (k && a >= h) {
              k = l;
            ...
            f.l(i.Of, g, a, n, j, e, c)
          };
          a.Oc = function(a) {
            if (a && !t) {
              t = a;
              a.rb($JssorPlayer$.kf, x)
            }
          };
          p && a.bc(p);
          h = a.Kb();
        ...
        var Fb = a.jg,
          ...
          Q = !a.of,
          y, v = b.D(p, "slides", Q),
          fb = b.D(p, "loading", Q) || b.Ab(g),
          Nb = b.D(p, "navigator", Q),
          dc = b.D(p, "arrowleft", Q),
          ac = b.D(p, "arrowright", Q),
          Lb = b.D(p, "thumbnavigator", Q),
          oc = b.m(v),
          mc = b.n(v),
          V, T = [],
          uc = b.tb(v);
        ...
        if (r) {
          ...
          if (kb) {
            cc = kb.wg;
            qb = kb.J;
            tb = u == 1 && r > 1 && qb && (!b.pd() || b.vd() >= 8)
          }
          ib = tb || u >= r || !(D & 1) ? 0 : a.id;
          X = (u > 1 || ib ? eb : -1) & a.hd;
          var Gb = v,
            C = [],
            A, L, Db = b.Hf(),
          ...
          Eb(W());
          b.a(v, "click", jc, d);
          b.a(p, "mouseout", b.ac(hc, p));
          b.a(p, "mouseover", b.ac(Ec, p));
          xb();
          a.Ub && b.a(g, "keydown", function(b) {
            if (b.keyCode == 37) ob(-a.Ub);
            else b.keyCode == 39 && ob(a.Ub)
          });
          var nb = a.Tb;
      ...
      var o = {
        ...
        r = function(e, C) {
          ...
          f.tc = function(D) {
            if (!u) {
              ...
              for (var f = 0; f < s; f++) {
                var C = b.pf();
                b.tf(C, f + 1);
                var l = b.Ye(g, "numbertemplate", C, d);
                b.E(l, "absolute");
                var v = f % (n + 1);
                b.G(l, !h ? o * v : f % i * o);
                b.F(l, h ? r * v : c.floor(f / (n + 1)) * r);
                b.R(e, l);
                B[f] = l;
                a.dc & 1 && b.a(l, "click", b.K(j, t, f));
                a.dc & 2 && b.a(l, "mouseover", b.ac(b.K(j, t, f), l));
                y[f] = b.mc(l)
              }
              u = d
            }
          ...
          x = a.gd;
          h = a.md - 1;
          a.qc == l && b.A(e, "noscale", d);
          a.ib && b.A(e, "autocenter", a.ib)
        },
        s = function(a, g, h) {
          var c = this;
          n.call(c);
          ...
          if (f.ib) {
            b.A(a, "autocenter", f.ib);
            b.A(g, "autocenter", f.ib)
          }
        };
      ...
      var t = function(n, g, l) {
        ...
        o = [f.Id, f.Hd, f.Ed, f.Cd, f.Bd, f.Ad, f.wd, f.Dd, f.Md, f.fe, f.ee, f.de, f.ed, f.ce, f.ae, f.Zd, f.Vd, f.Td, f.Sd, f.Rd, f.Qd, f.Ne, f.af, f.ag, f.Yf, f.Xf, f.Wf, f.Ze, f.Vf, f.Sf, f.Rf, f.Pf, f.Nf, f.Mf, f.bg, f.cg, f.hg];
        var u = {
          j: "y",
          k: "x",
          C: "m",
      ...
      jssor_1_slider_init = function() {
        ...
        function a() {
          var b = e.L.parentNode.clientWidth;
          if (b) {
            b = c.min(b, 1920);
            e.cf(b)
